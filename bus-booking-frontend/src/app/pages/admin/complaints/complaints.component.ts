    ...
    <div class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-base font-bold text-slate-900 dark:text-white">All Customer Complaints</h1>
            <p class="text-xs text-slate-500 dark:text-slate-400">Platform-wide complaints from all operators</p>
          </div>
        </div>
        <div class="flex items-center gap-3">
          <span class="text-sm text-slate-500 dark:text-slate-400">
            <span class="font-semibold text-orange-600">{{ openCount() }}</span> open ·
            <span class="font-semibold text-slate-700 dark:text-white">{{ complaints().length }}</span> total
          </span>
        </div>
      </div>
    </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl border shadow-sm overflow-hidden"
              ...
              <div class="px-5 py-3.5 border-b flex items-center justify-between gap-3 flex-wrap"
                ...
                <div class="flex items-center gap-3 flex-wrap">
                  ...
                  <span class="text-xs text-slate-400">Dep: {{ formatDate(c.departureUtc) }}</span>
                </div>
              ...
              <div class="px-5 py-4">
                ...
                @if (c.reply) {
                  <div class="mt-3 pl-3 border-l-2 border-green-400">
                    <p class="text-xs font-semibold text-green-700 dark:text-green-400 mb-0.5">Reply</p>
